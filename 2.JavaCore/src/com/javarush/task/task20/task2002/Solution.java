...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File yourFile = File.createTempFile("sashok", null, new File("/home/kajuga/projects/JavaRushTasks/2.JavaCore/src/com/javarush/task/task20/task2002/"));
            ...
            user1.setMale(true);
            User user2 = new User();
            user2.setFirstName("Owen");
            user2.setLastName("Hohlov");
            ...
            if (javaRush.equals(loadedObject)) {
                ...
                for (User user : loadedObject.users) {
                    System.out.println(
                            user.getFirstName() + " " + user.getLastName() + " " + user.isMale() + " " + user.getBirthDate() + " " + user.getCountry());
                }

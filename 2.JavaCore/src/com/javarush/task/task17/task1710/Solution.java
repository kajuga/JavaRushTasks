...
public class Solution {
    ...
    public static void print(int id) {
        ...
        if (person.getSex() == Sex.MALE) {
            System.out.printf("%s %s %s%n", person.getName(), "м", simpleDateFormat.format(person.getBirthDate()));
        } else {
            System.out.printf("%s %s %s%n", person.getName(), "ж", simpleDateFormat.format(person.getBirthDate()));
        }
    }
